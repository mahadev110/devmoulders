  ...
  <div class="container footer-top">
    <div class="row gy-4">
      <div class="col-lg-4 col-md-6 footer-about">
        <a href="index.html" class="footer-logo d-flex align-items-center me-auto">
      ...
      <div class="col-lg-4 col-md-12 footer-newsletter">
        ...
        <div class="footer-contact pt-3">
          <div class="d-flex mb-2">
            <i class="bi bi-telephone mt-1 me-2"></i>
            <div>
              <p>+91-98946 20985</p>
              <p>+91-98941 20985</p>
              <!-- Replace with second number -->
            </div>
          </div>

          <div class="d-flex">
            <i class="bi bi-envelope mt-1 me-2"></i>
            <div>
              <p>
...
<a href="https://web.whatsapp.com/send?phone=9894120985&amp;text=Hi%20Devmoulders%20I%20would%20want%20more%20information."
  class="whatsapp-float" target="_blank">
  <img src="assets/img/whatsapp-icon.png" alt="WhatsApp Chat" width="40" height="40" />
</a>
</body>
